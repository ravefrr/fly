...
local closeButton = Instance.new("TextButton") -- New close (X) button
...
Frame.Position = UDim2.new(0.5, -150, 0.5, -77) -- Centered and adjusted for size
Frame.Size = UDim2.new(0, 300, 0, 154)

up.Name = "lift"
up.Parent = Frame
up.BackgroundColor3 = Color3.fromRGB(255, 0, 0) -- Red button
up.Position = UDim2.new(0.03, 0, 0.1, 0)
...
down.Name = "down"
down.Parent = Frame
down.BackgroundColor3 = Color3.fromRGB(255, 0, 0) -- Red button
...
onof.Name = "onof"
onof.Parent = Frame
onof.BackgroundColor3 = Color3.fromRGB(255, 0, 0) -- Red button
...
plus.Name = "plus"
plus.Parent = Frame
plus.BackgroundColor3 = Color3.fromRGB(255, 0, 0) -- Red button
...
minus.Name = "minus"
minus.Parent = Frame
minus.BackgroundColor3 = Color3.fromRGB(255, 0, 0) -- Red button
...
minimizeButton.BackgroundColor3 = Color3.fromRGB(255, 0, 0) -- Red button
minimizeButton.Position = UDim2.new(0.5, -90, 1, 5) -- Positioning below the other buttons
minimizeButton.Size = UDim2.new(0, 80, 0, 20) -- Adjust size as needed
...
closeButton.Position = UDim2.new(1, -20, 0, 0) -- Positioning on the top-right corner
closeButton.Size = UDim2.new(0, 20, 0, 20) -- Square size for X button
